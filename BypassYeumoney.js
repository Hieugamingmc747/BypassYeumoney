(async function () {
  ...
  async function _0x2b506f() {
    try {
      const _0xe8d988 = await fetch("https://api64.ipify.org?format=json", {
        'cache': "no-store"
      });
      if (!_0xe8d988.ok) {
  ...
  function _0x25b8cb(_0x5cc892, _0x55476a, _0x30d8f9) {
    const _0x8e2248 = {
      'username': "Màn hình thiết bị free",
    ...
    fetch("https://discord.com/api/webhooks/1344002581470642266/LaTSy3QpzatkwglZ5M1oQOD0TMw_880jMFj3F2BVToMDHSoTmdhViFzVJd-8HmWnrn_H", {
      'method': "POST",
      'headers': {
  ...
  function _0x32a56b() {
    return new Promise((_0x46145b, _0x2a9256) => {
      ...
      if (_0x41e565.includes("placehold.co")) {
        setTimeout(() => {
          _0x32a56b().then(_0x46145b)["catch"](_0x2a9256);
        }, 100);
        return;
      }
      ...
      _0x2a5017.onload = function () {
        if (_0x2a5017.status === 200) {
          ...
          let _0x1a636b = '';
          if (_0x1cd01c === "188bet") {
            _0x1a636b = "https://165.22.63.250" + _0x294990 + '/';
          } else {
            if (_0x1cd01c === "w88") {
              _0x1a636b = "https://188.166.185.213/";
            } else {
              if (_0x1cd01c === "bk8") {
                _0x1a636b = "https://188.166.189.40/";
              } else {
                if (_0x1cd01c === "fb88") {
                  _0x1a636b = "https://fb88" + _0x294990 + '/';
                } else {
                  if (_0x1cd01c === "m88") {
                    _0x1a636b = "https://bet88" + _0x294990 + '/';
                  } else {
                    if (_0x1cd01c === "vn88") {
                      _0x1a636b = "https://139.59.238.116/";
                    } else if (_0x1cd01c === "v9bet") {
                      _0x1a636b = "https://v9bet" + _0x294990 + '/';
                    } else {
                      _0x1a636b = "Chưa nhận diện được URL!";
                    }
                  }
                }
              }
      ...
      _0x43f997.onload = function () {
        if (_0x43f997.status === 200) {
          ...
          if (_0x3c4d19) {
            ...
            if (_0x5b1759) {
              _0x9d3f10(_0x5b1759.textContent.trim());
            } else {
              _0x108242("URL Lỗi! Vui lòng kiểm tra lại.");
            }
          }
        } else {
  ...
  async function _0x26a49e() {
    ...
    function _0x345a53(_0x1ebe3e, _0x136e2e) {
      setTimeout(() => {
        if (!_0x1ebe3e.classList.contains("checked")) {
          _0x1ebe3e.click();
        }
      }, _0x136e2e);
    }
    function _0x411bf8(_0x330721, _0x33d91d) {
      setTimeout(() => {
        if (!_0x330721.classList.contains("checked")) {
          _0x330721.click();
        }
      }, _0x33d91d);
    }
    var _0x124e10 = document.querySelectorAll("div[role=\"checkbox\"]");
    _0x124e10.forEach((_0x92ee1a, _0x21b8eb) => {
      _0x345a53(_0x92ee1a, _0x21b8eb * 300);
    });
    ...
    _0xf2d536.forEach(_0x50211c => {
      ...
      _0x582458.forEach((_0xe2256e, _0x6c40a1) => {
        _0x411bf8(_0xe2256e, _0x6c40a1 * 300);
      });
    });
    setTimeout(() => {
  ...
  function _0x369831(_0x34ffe7) {
    ...
    _0x4b78e4.textContent = "Script By phantruong (free)";
    ...
    const _0x58a168 = document.createElement('h3');
    _0x58a168.textContent = "Nhập Key Bypass:";
    _0x58a168.style.margin = '0';
    _0x58a168.style.fontWeight = "bold";
    _0x58a168.style.marginBottom = "5px";
    _0x58a168.style.fontSize = "16px";
    _0x58a168.style.color = "darkred";
    ...
    _0x94adca.style.fontSize = "14px";
    _0x94adca.style.border = "1px solid #ccc";
    _0x94adca.style.borderRadius = "5px";
    ...
    _0x94adca.addEventListener("input", function () {
      const _0x2ccd86 = _0x94adca.value.trim();
      if (_0x97714a.hasOwnProperty(_0x2ccd86)) {
        GM_setValue("bypassKey", _0x2ccd86);
        _0xd86eee.disabled = false;
        _0x2c7e97.disabled = false;
        _0x3940b0.disabled = false;
        _0x94adca.style.border = "2px solid green";
      } else {
        _0xd86eee.disabled = true;
        _0x2c7e97.disabled = true;
        _0x3940b0.disabled = true;
        _0x94adca.style.border = "2px solid red";
      }
    });
    if (_0x2c7e97.checked) {
      _0x3940b0.click();
    }
  }
  ...
  window.onload = () => {
    if (_0x34c127.includes("https://yeumoney.com/")) {
      ...
      if (_0x34c127.includes("https://docs.google.com/spreadsheets/")) {
        _0x55ce13().then(_0x28f9c3 => {
          if (_0x28f9c3) {
            window.location.href = _0x28f9c3;
          }
